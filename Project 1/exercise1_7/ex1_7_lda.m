...
IRIS1 = meas_reduced(iris_labels==0,:); 		%Samples of Class 0
IRIS2 = meas_reduced(iris_labels==1,:);			%Samples of Class 1
IRIS3 = meas_reduced(iris_labels==2,:);			%Samples of Class 2
...
hold on
fprintf('\nVisualizing Iris database for LDA.\n\n');
plot(IRIS1(:, 1), IRIS1(:, 2), 'bo', 'MarkerFaceColor', 'b');
for i = 1:size(IRIS1, 1)
    drawLine(IRIS1(i,:), IRIS1(i,:), '--k', 'LineWidth', 1);
end

plot(IRIS2(:, 1), IRIS2(:, 2), 'rs', 'MarkerFaceColor', 'r');
for i = 1:size(IRIS2, 1)
    drawLine(IRIS2(i,:), IRIS2(i,:), '--k', 'LineWidth', 1);
end

plot(IRIS3(:, 1), IRIS3(:, 2), 'g+', 'MarkerFaceColor', 'g');
for i = 1:size(IRIS3, 1)
    drawLine(IRIS3(i,:), IRIS3(i,:), '--k', 'LineWidth', 1);
end
